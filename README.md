...
CAD
---
diseño - en el cad están los dos motores dc, llantas y dos servomotores para dar una idea de el acomodo
...
[código de probar control](https://github.com/annaastrs-svg/Battle-Bot-/blob/actualizacion/Probar%20control.py)

[código de control robot](https://github.com/annaastrs-svg/Battle-Bot-/blob/actualizacion/Control%20robot.py)

y 1 c++ en arduino IDE, este código es el que crea la red wifi, nos da info desde la terminal, ponemos seguridad por si perdemos conexión yyy define los motores los servos y así :B 
